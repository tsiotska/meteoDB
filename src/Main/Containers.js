      ...
      <div className="navi card p-2 container-fluid my-2">
        <nav>
          <div className="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a className="nav-item nav-link" id="nav-dwn_list-tab" data-toggle="tab" href="#nav-dwn_list" role="tab" aria-controls="nav-dwn_list" aria-selected="false">Файли
            </a>
            <a className="nav-item nav-link" id="nav-chart-tab" data-toggle="tab" href="#nav-chart" role="tab" aria-controls="nav-chart" aria-selected="false">Графік
            </a>
          </div>
        </nav>
