      ...
      <div className="row mx-auto  w_cont justify-content-center p-3">
        ...
        <div className="col-xs  align-self-center">
          <div className="col-auto d-flex">
            ...
            <p data-toggle="tooltip" data-placement="right" title="" data-original-title="Швидкість вітру">{e.wdsp.val}</p>
            <p>
              <span className="badge badge-primary badge-pill" data-toggle="tooltip" data-placement="right" title="" data-original-title="Кількість вимірювань">{e.wdsp.flag}</span>
            </p>
          </div>
          <div className="col-auto d-flex" data-toggle="tooltip" data-placement="right" title="" data-original-title="Максимальна швидкість вітру">
            <i className="wi wi-hurricane wi-fw"></i>
            <p>{e.wmax}</p>
          </div>
          <div className="col-auto d-flex" data-toggle="tooltip" data-placement="right" title="" data-original-title="Пориви вітру">
        ...
        <div className="col-4 w_gaudge_wrap">
          <div className="w_gaudge">
            <div className="col-auto w_max">
              <p data-toggle="tooltip" data-placement="right" title="" data-original-title="Максимальна температура">{e.max.val}<i className="wi wi-celsius"></i>
              </p>
              <span className="badge badge-primary badge-pill" data-toggle="tooltip" data-placement="right" title="" data-original-title="Кількість вимірювань">*</span>
            </div>
            <div className="col-auto w_aver">
              <p data-toggle="tooltip" data-placement="right" title="" data-original-title="Середня температура">{e.temp.val}<i className="wi wi-celsius"></i>
              </p>
              <span className="badge badge-primary badge-pill" data-toggle="tooltip" data-placement="right" title="" data-original-title="Кількість вимірювань">{e.temp.flag}</span>
            </div>
            <div className="col-auto w_dewp">
              <p data-toggle="tooltip" data-placement="right" title="" data-original-title="Точка роси">{e.dewp.val}<i className="wi wi-celsius"></i>
              </p>
              <span className="badge badge-primary badge-pill" data-toggle="tooltip" data-placement="right" title="" data-original-title="Кількість вимірювань">{e.dewp.flag}</span>
            </div>
            <div className="col-auto w_min">
              <p data-toggle="tooltip" data-placement="right" title="" data-original-title="Мінімальна температура">{e.min.val}<i className="wi wi-celsius"></i>
              </p>
              <span className="badge badge-primary badge-pill" data-toggle="tooltip" data-placement="right" title="" data-original-title="Кількість вимірювань">{e.min.flag}</span>
            </div>
          </div>
        </div>
        <div className="text-center w-100">
          <span className="badge m-2 badge-secondary" data-toggle="tooltip" data-placement="right" title="" data-original-title="ІD станції">ID: {e.id}</span>
          <span className="badge m-2 badge-secondary" data-toggle="tooltip" data-placement="right" title="" data-original-title="ІD станції у WBAN">WBAN: {e.wban}</span>
        </div>
      </div>
